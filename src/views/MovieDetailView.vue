...
const route = useRoute(); // 주소창 파라미터 추출용
const router = useRouter(); // 뒤로가기 조종용
        ...
        <div class="info-zone">
          ...
          <div class="meta-dashboard">
            ...
            <span class="badge runtime"
              >{{ store.selectedMovie?.runtime }}분</span
            >
